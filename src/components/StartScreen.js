...
export default function StartScreen(props) {
    ...
    return (
        ...
        <img className={s.logoRS} src="https://rs.school/images/rs_school_js.svg" alt="Logo"></img>
        <a className={s.link} href="https://github.com/leeshko/">https://github.com/leeshko/</a>
